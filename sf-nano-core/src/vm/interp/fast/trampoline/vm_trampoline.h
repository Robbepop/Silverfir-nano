...
#define PARAMS struct Ctx* ctx, struct Instruction* pc, uint64_t* fp, uint64_t t0, uint64_t t1, uint64_t t2, uint64_t t3, NextHandler nh
#define ARGS ctx, pc, fp, t0, t1, t2, t3, nh
